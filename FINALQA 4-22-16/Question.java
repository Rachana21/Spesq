...
public class Question extends Actor
{
    ...
    public void addAnswers(){
       int xStart=300; //top left corner of where to start answers
       int yStart=200; // y location for starting answers
       getWorld().addObject(ans[0],xStart,yStart);
       getWorld().addObject(ans[1],xStart,yStart+40);
       getWorld().addObject(ans[2],xStart,yStart+80);
       getWorld().addObject(ans[3],xStart,yStart+120);
    }
